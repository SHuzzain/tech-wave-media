...
Headless magazine site: **Next.js** frontend + **WordPress** admin. Based on [9d8dev/next-wp](https://github.com/9d8dev/next-wp).

- Editor guide: [docs/CLIENT-HANDOVER.md](docs/CLIENT-HANDOVER.md)
- WordPress import, roles, and plugins: [wordpress/SETUP.md](wordpress/SETUP.md)
